...
cat data/results/bam_paths.txt | cut -f6- -d'/' | cut -f-1 -d'.' | parallel -j1 'mosdepth -n -t 4 --fast-mode --by 10000 data/results/mosdepth/{} data/results/var_call/allacma_fusca/bwamem/{}.GCA_947179485.1.simple_header.earlGrey_masked.sorted.bam' 
