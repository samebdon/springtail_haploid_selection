...
params.vcf = "$launchDir/data/results/var_call/allacma_fusca/4_alt_all/allacma_fusca.hard_filtered.sorted.vcf.gz"
params.vcf_index = "$launchDir/data/results/var_call/allacma_fusca/4_alt_all/allacma_fusca.hard_filtered.sorted.vcf.gz.csi"
