...
workflow {
        ...
        gene_pop_flow_SFS_1(params.genome_fasta_1, params.genome_dict_1, params.vcf_1 ,params.vcf_index_1, params.annot_1, infer_orthology_flow.out[2], params.species_1)
        gene_pop_flow_SFS_2(params.genome_fasta_2, params.genome_dict_2, params.vcf_2 ,params.vcf_index_2, params.annot_2, infer_orthology_flow.out[3], params.species_2)
}
